...
class SSLContext(ssl.SSLContext):
    ...
    def __eq__(self, other: typing.Any) -> bool:
        return (
            ...
            and self.hostname_checks_common_name == other.hostname_checks_common_name
            ...
            and self.maximum_version == other.maximum_version
            and self.verify_flags == other.verify_flags
            and self.verify_locations == other.verify_locations
            and self.verify_store == other.verify_store
            and self.verify_store_ctx == other.verify_store_ctx
            and self._load_client_certs(cert) == self._load_client_certs(cert)
        )
